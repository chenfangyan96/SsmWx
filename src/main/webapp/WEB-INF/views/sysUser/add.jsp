		...
		<div class="box">
			<div class="box_border">
				<div class="box_center">
					<form action="${ctx }/sysUser/add" class="jqtransform" onsubmit="return toVaild()" method="post">
					<table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td class="td_right">账号：</td>
							<td><input type="text" name="sysUser.username" id="username" class="input-text lh30" size="40" maxlength="20"></td>
						</tr>
						<tr>
							<td class="td_right">密码：</td>
							<td><input type="password" name="sysUser.password" id="password" class="input-text lh30" size="40" maxlength="20"></td>
						</tr>
         				<tr>
